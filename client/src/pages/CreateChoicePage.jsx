      ...
      <main className="flex-grow flex flex-col items-center justify-center p-margin-mobile md:p-margin-desktop py-16">
        <div className="w-full max-w-3xl">
          <div className="text-center mb-10">
            <h1 className="font-headline-lg text-headline-lg text-on-background mb-2">Create a Room</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-gutter">
            <button
              ...
              className="text-left bg-surface-container-lowest border border-surface-variant rounded-xl p-8 hover:border-primary transition-colors shadow-sm"
            >
            ...
            <button
              ...
              className="text-left bg-surface-container-lowest border border-surface-variant rounded-xl p-8 hover:border-error transition-colors shadow-sm"
            >
